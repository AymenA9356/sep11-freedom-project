...
//             retString += ' If weight below 19.000 lbs, set the value to 19.000 min |';
//             $("#centerTable").css("border", "red");
...
//         }
//         if (runwaySlope > 5){
//             retString += '| I would seriously question departing/landing there mate. If you want to calculate some reference values use 5 degrees and below. |';
//             $("#centerTable").css("border", "red");
//         }
...
//             retString += '| Do not fly, you are going to crash';
//             $("#centerTable").css("border", "red");
//         }
